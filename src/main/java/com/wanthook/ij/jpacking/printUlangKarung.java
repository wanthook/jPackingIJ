 ...
 * @author wanthook
 */
public class printUlangKarung extends javax.swing.JFrame {
    ...
    /**
     * Creates new form printUlangKarung
     */
    public printUlangKarung(){}
    
    public printUlangKarung(varApp VarApp) {
        this.VarApp = VarApp;
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Print Ulang Barcode Karung");
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder("Form Print Ulang Barcode Karung"));
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel4Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtDeskripsi, javax.swing.GroupLayout.PREFERRED_SIZE, 156, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addComponent(cmbTanpaLogo, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        {
            if(txtRegStart.getText().isEmpty())
            {
                JOptionPane.showMessageDialog(null, "No Registrasi belum diisi.");
                return;
            }
            String param = "packing_id="+packingId+
                       "&reg="+txtRegStart.getText()+
                       "&regEnd="+txtRegEnd.getText();
...
//            System.out.println(param);
            if(hR.isJSONValid(htt))
            {
                ...
                for(int i=0 ; i<jA.length() ; i++)
                {
                    ...
                    if(txtTipeBerat.getText().equals("SISA CONES") || txtTipeBerat.getText().equals("PARCEL") || txtTipeBerat.getText().equals("SAMPLE"))
                    {
                        berat = jA.getJSONObject(i).getString("berat_sc");
                    }
                    else if(txtTipeBerat.getText().equals("ACTUAL"))
                    {
                        berat = jA.getJSONObject(i).getString("actual");
                    }
                    else
                    {
                        berat = jA.getJSONObject(i).getString("standar");
                    }
                    
                    String prop[] = {
                        jA.getJSONObject(i).getString("material"),
                        jA.getJSONObject(i).getString("batch"),
                        VarApp.mesinKode + String.format("%010d",(int)jA.getJSONObject(i).get("no")),
                        berat,
                        jA.getJSONObject(i).get("no_reg").toString(),
                        jA.getJSONObject(i).get("bruto").toString(),
                        jA.getJSONObject(i).get("tipe_berat").toString(),
                        VarApp.userName
                    };
                    
                    String label = bP.karungBarcode(options, prop);
//                    System.out.println(label.replaceAll("<ETX>", "<ETX>"+System.getProperty("line.separator")));
    ...
    private void tblDMaterialMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDMaterialMouseClicked
        ...
        if(evt.getClickCount()==2)
        {
            ...
            int id = (int)dataDMaterial[row][9];
            packingId = id;
...
//        System.out.println(param);
        ...
        JSONObject jO = new JSONObject(htt);
        JSONArray jA = jO.getJSONArray("data");
        printUlangKarung.dataDMaterial = null;
